# 💳 Paynes - Комфортные платежи

Современная платежная система на Laravel 11 + PHP 8.3 + Vue.js 3 SPA
...
- **Email:** support@paynes.uz
- **Telegram:** @paynes_support
- **Website:** https://paynes.uz

---

## 🎨 Брендинг

Paynes использует современный дизайн с корпоративными цветами:
- **Основной синий:** #1A77C9
- **Темный синий:** #0D4F8F
- **Светлый синий:** #4A9AE1

Логотип представляет собой стрелку в форме буквы "P", символизирующую движение вперед и комфортные платежи.
